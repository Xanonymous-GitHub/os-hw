...
index and continually adds the head movement from the starting index in
order received. If at end of array, start from index zero and continually
...
and continually goes down to zero (if included in random array or not). Then
